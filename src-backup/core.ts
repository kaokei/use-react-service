...
export function useService<T, S extends object>(
  ...
  if (!scope.current) {
    // https://github.com/vuejs/pinia/blob/98c6419c12ebd133b9b535360f071290053494e1/packages/pinia/src/createPinia.ts#L11C17-L11C28
    scope.current = effectScope(true);
    scope.current.run(() => {
