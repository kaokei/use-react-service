...
export default function App() {
  return (
    <div>
      ...
      <p>
        <b>总结：</b>{' '}
        总体上来说并不是很推荐大家使用这两个api，除非是在非常简单的应用中可以尝试一下。非常推荐使用后面介绍的useService和useSetup。同时注意到所有组件需要被observer进行包裹。还注意到如果使用类来封装数据和方法，那么在组件的模版中直接使用这个add方法，会发现找不到this。这个问题在react中是非常常见的，可以使用bind或者定义新的函数来解决。
      </p>
